...
/**
 * Godot Android Plugin for NativeGallery GDExtension.
 * 
 * This plugin handles Android Activity results for gallery intents
 * and exposes methods that the GDExtension can call via Engine.get_singleton().
 */
        ...
        MediaScannerConnection.scanFile(
            ...
            new MediaScannerConnection.OnScanCompletedListener() {
                ...
                public void onScanCompleted(String scanPath, Uri uri) {
                    // Scan completed; file should now be visible in gallery apps
                }
            }
        );
    }
